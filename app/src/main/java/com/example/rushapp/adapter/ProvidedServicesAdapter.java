...
public class ProvidedServicesAdapter extends RecyclerView.Adapter<ProvidedServicesAdapter.MyViewHolder>{

    private List<ServiceCard> providedCardList;
    private Context context;


    public ProvidedServicesAdapter(List<ServiceCard> providedCardList , Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProvidedServicesAdapter.MyViewHolder(recyclerRowBinding);
    }

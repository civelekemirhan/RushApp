...
public class ProviderProfileScreen extends Fragment {
    ...
    public ProviderProfileScreen(String userMail, String userNickname, String userJob,MenuItem item) {
        ...
        binding.editProfileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("OK", (dialog, which) -> {
                    ...
                    TextInputEditText editUsetPassword=customLayout.findViewById(R.id.confirmpass);
                    DBOperations dbo =new DBOperations();
                    ...
                    String pass=editUsetPassword.getText().toString();
